...
function ParticleCanvas() {
  ...
  useEffect(() => {
    ...
    const COLORS = ["#3b82f6", "#6366f1", "#8b5cf6", "#06b6d4", "#a78bfa", "#60a5fa"];
    ...
    const draw = () => {
      ...
      particles.forEach((p) => {
        ...
        grad.addColorStop(0, p.color + Math.floor(pulsedAlpha * 255).toString(16).padStart(2, "0"));
...
const projects: Project[] = [
  { img: "/projects/famor-thumb.png", alt: "FAMOR", tag: "Mobile App", title: "FAMOR — Five G Auto Motor", desc: "Merancang UI/UX aplikasi mobile showroom motor untuk mempermudah booking service, monitoring kendaraan, dan simulasi cicilan dengan tampilan modern dan user-friendly.", features: ["Booking Service", "Riwayat Service", "Simulasi Cicilan", "Customer Service"], link: figmaFamor, accent: "#3b82f6", tool: "Figma", toolIcon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" },
  { img: "/projects/famor-admin-thumb.png", alt: "FAMOR Admin", tag: "Dashboard", title: "FAMOR Admin Panel", desc: "Merancang dashboard admin berbasis web untuk manajemen operasional showroom motor, mulai dari pengelolaan produk, stok kendaraan, hingga monitoring order dan layanan servis.", features: ["Dashboard Analytics", "Manajemen Produk", "Order & Stok", "Service Management"], link: figmaAdmin, accent: "#6366f1", tool: "Figma", toolIcon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" },
  { img: "/projects/buu-burger-thumb.png", alt: "Buu Burger App", tag: "Mobile App", title: "Buu Burger — Mobile App", desc: "Mendesain aplikasi mobile pemesanan makanan untuk brand fast food lokal, menghadirkan pengalaman order yang cepat, intuitif, dan menarik dengan fitur promo dan wishlist.", features: ["Order Makanan", "Kategori Menu", "Promo & Diskon", "Wishlist & Favorit"], link: figmaBuu, accent: "#f97316", tool: "Figma", toolIcon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" },
  { img: "/projects/buu-burger-web-thumb.png", alt: "Buu Burger Web", tag: "Website", title: "Buu Burger — Website", desc: "Merancang website restoran fast food dengan tampilan modern dan responsif, mencakup informasi menu, promo aktif, dan alur pemesanan online yang mudah digunakan.", features: ["Informasi Menu", "Promo & Diskon", "Pemesanan Online", "Responsif"], link: figmaBuuWeb, accent: "#ef4444", tool: "Figma", toolIcon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" },
  { img: "/projects/sekala-thumb.png", alt: "Sekala", tag: "Website", title: "Sekala — Platform Konten Digital", desc: "Mendesain platform layanan konten digital berbasis web yang memudahkan pelaku usaha memesan konten kreatif secara terstruktur, lengkap dengan manajemen paket dan dashboard klien.", features: ["Request Konten", "Manajemen Paket", "Dashboard Klien", "Responsif"], link: figmaSekala, accent: "#0ea5e9", tool: "Figma", toolIcon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" },
  { img: "/projects/ubbc-cbs-thumb.png", alt: "UBBC CBS", tag: "Graphic Design", title: "Content Design UBBC & CBS", desc: "Merancang aset visual promosi untuk event fitness & bodybuilding UBBC dan brand CBS, mencakup poster event, konten feed Instagram, materi promo produk, dan backdrop panggung.", features: ["Poster Event", "Feed Instagram", "Promo Produk", "Backdrop"], link: figmaUBBC, accent: "#f59e0b", tool: "Figma & Canva", toolIcon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg", toolIcon2: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/canva/canva-original.svg" },
  { img: "/projects/social-media-carousel-thumb.png", alt: "Carousel", tag: "Graphic Design", title: "Social Media Carousel — Branding", desc: "Mendesain konten carousel media sosial untuk kebutuhan branding dan promosi digital, dengan konsep visual modern dan premium yang mendukung identitas brand korporat.", features: ["Social Media Carousel", "Branding Visual", "Promosi Digital", "Corporate Design"], link: canvaCarousel, accent: "#0284c7", tool: "Canva", toolIcon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/canva/canva-original.svg", linkLabel: "Lihat di Canva" },
];

const experiences = [
  { role: "Content Creator & Visual Designer", company: "UBBC — Bali Body Contest", period: "Nov 2025 — Jan 2026", type: "Event-Based", accent: "#f59e0b", points: ["Membuat konten dokumentasi dan promosi event Bali Body Contest secara konsisten.", "Merancang desain panggung, poster, dan aset visual pendukung acara yang sesuai konsep.", "Berkolaborasi lintas tim untuk memastikan seluruh output visual selaras dengan branding event.", "Mengadaptasi desain secara fleksibel sesuai kebutuhan teknis dan arahan klien di lapangan."] },
  { role: "Daily Worker / Assistant Supervisor", company: "Klumpu Catering", period: "Mei 2023 — Present", type: "Part-Time", accent: "#3b82f6", points: ["Memberikan pelayanan langsung kepada pelanggan pada berbagai acara formal dan non-formal.", "Membantu supervisor dalam mengoordinasikan tim service selama acara berlangsung.", "Mengawasi alur kerja tim, memastikan persiapan, penyajian, dan kebersihan berjalan sesuai standar.", "Terbiasa bekerja secara kolaboratif dalam lingkungan yang dinamis dan berorientasi pada target."] },
];

const educations = [
  { degree: "S1 Sistem Informasi", school: "Primakara University", period: "2023 — Present", accent: "#3b82f6", points: ["Fokus pada pengembangan sistem informasi, aplikasi, dan solusi digital berbasis teknologi.", "Mengembangkan pemahaman mendalam tentang teknologi, desain antarmuka, dan produk digital."] },
  { degree: "Rekayasa Perangkat Lunak", school: "SMK Wira Harapan", period: "2020 — 2023", accent: "#6366f1", points: ["Mempelajari dasar-dasar pemrograman dan pengembangan aplikasi berbasis web dan desktop.", "Terlibat aktif dalam proyek pembuatan aplikasi dan desain digital sebagai bagian dari kurikulum."] },
];
...
const skillCategories = [
  { label: "UI/UX Design", color: "#a78bfa", bg: "rgba(167,139,250,0.07)", border: "rgba(167,139,250,0.18)", icon: "✦", skills: [{ name: "Wireframing" }, { name: "Prototyping" }, { name: "Design System" }, { name: "User Research" }, { name: "Responsive Design" }] },
  { label: "Frontend Development", color: "#60a5fa", bg: "rgba(96,165,250,0.07)", border: "rgba(96,165,250,0.18)", icon: "◈", skills: [{ name: "HTML", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" }, { name: "CSS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" }, { name: "JavaScript", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" }, { name: "Tailwind CSS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg" }] },
  { label: "Backend Development", color: "#34d399", bg: "rgba(52,211,153,0.07)", border: "rgba(52,211,153,0.18)", icon: "⬡", skills: [{ name: "PHP", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/php/php-original.svg" }, { name: "MySQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" }] },
  { label: "Mobile Development", color: "#f472b6", bg: "rgba(244,114,182,0.07)", border: "rgba(244,114,182,0.18)", icon: "◉", skills: [{ name: "Flutter", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/flutter/flutter-original.svg" }] },
  { label: "Tools", color: "#fbbf24", bg: "rgba(251,191,36,0.07)", border: "rgba(251,191,36,0.18)", icon: "⚙", skills: [{ name: "Figma", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg" }, { name: "VS Code", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg" }, { name: "GitHub", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg", invert: true }, { name: "Postman", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postman/postman-original.svg" }, { name: "Canva", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/canva/canva-original.svg" }, { name: "Android Studio", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/androidstudio/androidstudio-original.svg" }] },
];

const contactLinks = [
  { label: "GitHub", value: "github.com/haidzanursafa", href: "https://github.com/haidzanursafa", accent: "#ffffff", accentBg: "rgba(255,255,255,0.08)", accentBorder: "rgba(255,255,255,0.18)", icon: (<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.374 0 0 5.373 0 12c0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0112 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z"/></svg>) },
  { label: "Email", value: "dimashaidzanursafa@gmail.com", href: "mailto:dimashaidzanursafa@gmail.com", accent: "#60a5fa", accentBg: "rgba(59,130,246,0.08)", accentBorder: "rgba(59,130,246,0.22)", icon: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#60a5fa" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"/></svg>) },
  { label: "WhatsApp", value: "+62 896 0645 2121", href: "https://wa.me/6289606452121", accent: "#34d399", accentBg: "rgba(52,211,153,0.08)", accentBorder: "rgba(52,211,153,0.22)", icon: (<svg width="18" height="18" viewBox="0 0 24 24" fill="#34d399"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>) },
  { label: "Instagram", value: "@hdznr._", href: "https://www.instagram.com/hdznr._?igsh=MWY3b2Zoc3RpY2VqOQ==", accent: "#f472b6", accentBg: "rgba(244,114,182,0.08)", accentBorder: "rgba(244,114,182,0.22)", icon: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#f472b6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>) },
];
...
export default function Home() {
  ...
  const auroraRef = useRef<number>(0);
  ...
  useEffect(() => {
    ...
    const animate = () => {
      phase += 0.003;
      setAuroraPhase(phase);
      auroraRef.current = requestAnimationFrame(animate);
    };
    auroraRef.current = requestAnimationFrame(animate);
    return () => cancelAnimationFrame(auroraRef.current);
  }, []);
  ...
  // Aurora orb positions driven by phase
  const auroraOrbs = [
    { x: 15 + 8 * Math.sin(auroraPhase * 0.7), y: 10 + 6 * Math.cos(auroraPhase * 0.5), color: "rgba(59,130,246,0.13)", size: 700 },
    { x: 70 + 10 * Math.cos(auroraPhase * 0.4), y: 20 + 8 * Math.sin(auroraPhase * 0.6), color: "rgba(139,92,246,0.10)", size: 600 },
    { x: 40 + 12 * Math.sin(auroraPhase * 0.3 + 1), y: 50 + 10 * Math.cos(auroraPhase * 0.8), color: "rgba(6,182,212,0.07)", size: 500 },
    { x: 80 + 6 * Math.cos(auroraPhase * 0.9), y: 70 + 8 * Math.sin(auroraPhase * 0.35), color: "rgba(99,102,241,0.09)", size: 550 },
    { x: 20 + 9 * Math.sin(auroraPhase * 0.55 + 2), y: 80 + 7 * Math.cos(auroraPhase * 0.45), color: "rgba(167,139,250,0.08)", size: 480 },
  ];

  return (
    <main className="min-h-screen text-white overflow-hidden" style={{ background: "#020810", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .grid-glow-h {
          ...
          left: 0; right: 0;
          height: 1px;
          background: linear-gradient(90deg, transparent 0%, rgba(59,130,246,0.4) 30%, rgba(139,92,246,0.4) 60%, transparent 100%);
        ...
        .grid-glow-v {
          ...
          top: 0; bottom: 0;
          width: 1px;
          background: linear-gradient(180deg, transparent 0%, rgba(99,102,241,0.4) 30%, rgba(6,182,212,0.3) 70%, transparent 100%);
          animation: sweep-v 12s ease-in-out infinite;
          pointer-events: none;
        }
        @keyframes sweep-h {
          0%   { top: -2px; opacity: 0; }
        ...
        .btn-blue::before { content:''; position:absolute; inset:0; background: linear-gradient(135deg, rgba(255,255,255,0.2), transparent); transform: translateX(-100%); transition: transform 0.4s ease; }
        .btn-blue:hover::before { transform: translateX(0); }
        .btn-blue:hover { transform: translateY(-2px); box-shadow: 0 8px 32px rgba(59,130,246,0.55); }

        .btn-ghost { transition: all 0.3s ease; border: 1px solid rgba(255,255,255,0.1); }
        .btn-ghost:hover { border-color: rgba(59,130,246,0.4); background: rgba(59,130,246,0.08); transform: translateY(-2px); }
        ...
        .why-card { transition: all 0.35s cubic-bezier(0.16,1,0.3,1); cursor: default; }
        .why-card:hover { transform: translateY(-6px); border-color: rgba(59,130,246,0.3) !important; box-shadow: 0 20px 40px rgba(0,0,0,0.4), 0 0 0 1px rgba(59,130,246,0.1); }

        .skill-category { transition: all 0.35s cubic-bezier(0.16,1,0.3,1); }
        .skill-category:hover { transform: translateY(-4px); box-shadow: 0 24px 48px rgba(0,0,0,0.3); }

        .skill-badge { transition: all 0.22s cubic-bezier(0.16,1,0.3,1); cursor: default; }
        .skill-badge:hover { transform: translateY(-3px) scale(1.07); filter: brightness(1.15); }

        .contact-card { transition: all 0.3s cubic-bezier(0.16,1,0.3,1); text-decoration: none; display: flex; align-items: center; gap: 16px; }
        ...
        @media (max-width: 900px) { .hero-text-col { order: 1; } .hero-photo-col { order: 2; padding-bottom: 48px; } }
      `}</style>
      ...
      {/* 2. Animated grid */}
      <div className="fixed inset-0 bg-grid z-0" style={{ opacity: 0.8 }} />

      {/* 3. Sweeping grid glow lines */}
      <div className="fixed inset-0 overflow-hidden z-0 pointer-events-none">
        <div className="grid-glow-h" style={{ animationDelay: "0s" }} />
        <div className="grid-glow-h" style={{ animationDelay: "4s" }} />
        <div className="grid-glow-v" style={{ animationDelay: "2s" }} />
        <div className="grid-glow-v" style={{ animationDelay: "8s" }} />
      </div>

      {/* 4. Aurora orbs (smooth JS-driven) */}
      ...
      <nav
        ...
        style={{
          background: scrollY > 50 ? "rgba(2,8,16,0.92)" : "transparent",
          backdropFilter: scrollY > 50 ? "blur(24px)" : "none",
          borderBottom: scrollY > 50 ? "1px solid rgba(59,130,246,0.08)" : "1px solid transparent",
          transition: "all 0.5s ease",
        }}
      >
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: "linear-gradient(135deg, #1d4ed8, #7c3aed)" }}>
        ...
        <button className="hamburger items-center justify-center w-9 h-9 rounded-xl" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }} onClick={() => setMobileMenuOpen(!mobileMenuOpen)} aria-label="Toggle menu">
          {mobileMenuOpen
      ...
      {mobileMenuOpen && (
        <div className="mobile-menu fixed top-[61px] left-0 right-0 z-40 mx-4 rounded-2xl overflow-hidden" style={{ background: "rgba(4,10,20,0.97)", border: "1px solid rgba(59,130,246,0.1)", backdropFilter: "blur(24px)" }}>
          <div className="flex flex-col py-3">
            {navItems.map((item) => (
              <a key={item} href={item === "Home" ? "#" : `#${item.toLowerCase()}`} className="px-5 py-3 text-sm text-white/50 hover:text-white hover:bg-white/5 transition-colors" onClick={() => setMobileMenuOpen(false)}>{item}</a>
            ))}
      ...
      {/* ── HERO ── */}
      <section className="relative section-px max-w-7xl mx-auto min-h-[95vh] z-10">
        <div className="hero-grid" style={{ minHeight: "95vh" }}>
          ...
          <div className="hero-text-col space-y-6 relative z-10 py-20 md:py-24">
            ...
            <div className="hl6 flex gap-3 flex-wrap">
              <a href="#projects" className="btn-blue text-white px-6 py-3 rounded-xl text-sm font-semibold">Lihat Project ↓</a>
              <a href="#contact" className="btn-ghost text-white/70 px-6 py-3 rounded-xl text-sm font-semibold">Hubungi Saya</a>
            </div>
          ...
          <div className="hero-photo-col relative z-10 py-10 md:py-24">
            <div className="hero-photo-wrapper">
              <div className="absolute inset-[-30px] rounded-full border border-blue-500/10 hidden md:block" style={{ animation: "spin-slow 25s linear infinite" }}>
                <div className="absolute top-0 left-1/2 w-2 h-2 rounded-full" style={{ background: "#3b82f6", transform: "translateX(-50%)", boxShadow: "0 0 10px #3b82f6" }} />
              </div>
              <div className="absolute inset-[-55px] rounded-full border border-violet-500/[0.06] hidden md:block" style={{ animation: "spin-reverse 35s linear infinite" }}>
                <div className="absolute bottom-0 right-1/4 w-1.5 h-1.5 rounded-full bg-violet-500" style={{ boxShadow: "0 0 8px #7c3aed" }} />
              </div>
              <div className="absolute inset-0" style={{ background: "radial-gradient(circle at 50% 70%, rgba(59,130,246,0.35) 0%, transparent 65%)", filter: "blur(40px)", borderRadius: "50%" }} />
              <div className="relative w-full h-full rounded-3xl overflow-hidden" style={{ border: "1px solid rgba(59,130,246,0.15)" }}>
                <Image src="/dimas-new.png" alt="Dimas" fill className="object-cover project-img" priority />
                <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(2,8,16,0.5) 0%, transparent 50%)" }} />
              </div>
              <div className="floating-icons">
                {[
                  ...
                  <div key={label} className={`absolute flex flex-col items-center gap-1 ${cls}`} style={style}>
                    <div style={{ background: "rgba(2,8,16,0.85)", border: "1px solid rgba(59,130,246,0.15)", borderRadius: 14, padding: 10, backdropFilter: "blur(16px)", boxShadow: "0 8px 24px rgba(0,0,0,0.6)" }}>
      ...
      {/* ── ABOUT ── */}
      <section id="about" className="section-px pb-24 max-w-7xl mx-auto relative z-10">
        <FadeIn>
          <div className="about-grid rounded-3xl p-6 md:p-10 glass relative overflow-hidden">
            <div className="absolute -bottom-16 -right-16 w-56 h-56 rounded-full" style={{ background: "radial-gradient(circle, rgba(59,130,246,0.08) 0%, transparent 70%)", pointerEvents: "none" }} />
            <div className="space-y-4">
              ...
              <p className="text-white/40 text-sm leading-loose" style={{ fontWeight: 300 }}>Saya Dimas, mahasiswa Sistem Informasi semester 7 di Primakara University. Saya memiliki fokus di bidang <span className="text-blue-400 font-medium">UI/UX Design</span>, <span className="text-blue-400 font-medium">Frontend Development</span>, dan <span className="text-blue-400 font-medium">Creative Design</span>.</p>
              <p className="text-white/40 text-sm leading-loose" style={{ fontWeight: 300 }}>Selain kuliah, saya aktif mengerjakan berbagai project desain dan digital — mulai dari desain aplikasi, website, hingga konten visual untuk kebutuhan brand dan event.</p>
            </div>
      ...
      {/* ── WHY ME ── */}
      <section id="whyme" className="section-px pb-24 max-w-7xl mx-auto relative z-10">
        <FadeIn>
          <div className="mb-10">
      ...
      {/* ── EDUCATION ── */}
      <section id="education" className="section-px pb-24 max-w-7xl mx-auto relative z-10">
        <FadeIn>
          <div className="mb-10">
      ...
      {/* ── EXPERIENCE ── */}
      <section id="experience" className="section-px pb-24 max-w-7xl mx-auto relative z-10">
        <FadeIn>
          <div className="mb-10">
      ...
      {/* ── SKILLS ── */}
      <section id="skills" className="section-px pb-24 max-w-7xl mx-auto relative z-10">
        <FadeIn>
          <div className="mb-10">
            ...
            <FadeIn key={cat.label} delay={ci * 0.07}>
              <div className="skill-category rounded-2xl p-5 md:p-6 h-full" style={{ background: "rgba(255,255,255,0.02)", border: `1px solid ${cat.border}`, boxShadow: `0 0 40px ${cat.bg}` }}>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center text-base font-black flex-shrink-0" style={{ background: cat.bg, border: `1px solid ${cat.border}`, color: cat.color }}>{cat.icon}</div>
                  <div>
      ...
      {/* ── PROJECTS ── */}
      <section id="projects" className="section-px pb-24 max-w-7xl mx-auto relative z-10">
        <FadeIn>
          <div className="mb-10">
          ...
          {projects.map((p, i) => (
            <FadeIn key={p.title} delay={i * 0.06}>
              <div
                ...
                style={{ background: "rgba(255,255,255,0.02)", border: `1px solid ${activeProject === i ? p.accent + "40" : "rgba(255,255,255,0.06)"}`, boxShadow: activeProject === i ? `0 32px 64px ${p.accent}15` : "none", transition: "all 0.4s cubic-bezier(0.16,1,0.3,1)" }}
                onMouseEnter={() => setActiveProject(i)}
                onMouseLeave={() => setActiveProject(null)}
              >
                <div className="project-inner">
                  <div className="relative overflow-hidden" style={{ minHeight: 240 }}>
                    <Image src={p.img} alt={p.alt} fill className="object-cover project-img" sizes="(max-width: 768px) 100vw, 50vw" />
                    <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, rgba(2,8,16,0.3) 0%, transparent 50%)" }} />
                  ...
                  <div className="flex flex-col justify-center p-6 md:p-10 space-y-3 md:space-y-4">
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      ...
                      {p.toolIcon2 && <img src={p.toolIcon2} width={14} height={14} alt="tool2" />}
                      <span className="text-xs text-white/25">{p.tool}</span>
                    </div>
                    <a href={p.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white text-xs font-semibold px-5 py-2.5 rounded-xl w-fit" style={{ background: p.accent, boxShadow: `0 4px 16px ${p.accent}40`, transition: "all 0.3s ease" }} onMouseEnter={e => (e.currentTarget.style.transform = "translateY(-2px)")} onMouseLeave={e => (e.currentTarget.style.transform = "translateY(0)")}>
      ...
      {/* ── CONTACT ── */}
      <section id="contact" className="section-px pb-24 max-w-7xl mx-auto relative z-10">
        <FadeIn>
          <div className="mb-10">
        ...
        <FadeIn delay={0.1}>
          <div className="glass rounded-3xl p-6 md:p-10 relative overflow-hidden">
            <div className="absolute -top-24 -right-24 w-64 h-64 rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(59,130,246,0.08) 0%, transparent 70%)" }} />
            <div className="absolute -bottom-20 -left-20 w-52 h-52 rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(167,139,250,0.06) 0%, transparent 70%)" }} />
            <div className="contact-grid relative z-10">
              <div className="space-y-4">
                <h3 className="syne text-2xl md:text-3xl font-black leading-snug">Let&apos;s build something<br /><span className="gradient-text">amazing together.</span> 🚀</h3>
                <p className="text-white/35 text-sm leading-loose" style={{ fontWeight: 300 }}>Saat ini terbuka untuk internship, freelance project, dan kolaborasi kreatif di bidang desain dan teknologi. Jangan ragu untuk menghubungi saya!</p>
                <div className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-green-400 dot-live" />
                  <span className="text-green-400 text-xs font-semibold">Available — Bali, Indonesia</span>
                </div>
                <button onClick={handleCopyEmail} className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium" style={{ background: copied ? "rgba(52,211,153,0.1)" : "rgba(59,130,246,0.08)", border: copied ? "1px solid rgba(52,211,153,0.3)" : "1px solid rgba(59,130,246,0.2)", color: copied ? "#34d399" : "#60a5fa", transition: "all 0.3s ease" }}>
                  {copied ? (<><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>Email tersalin!</>) : (<><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" /><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1" /></svg>Salin email saya</>)}
                </button>
                <a href="/CV_Dimas_Haidzanur.pdf" download className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-medium" style={{ background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.25)", color: "#a78bfa", transition: "all 0.3s ease" }}>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M12 15V3M12 15l-4-4M12 15l4-4M3 17v2a2 2 0 002 2h14a2 2 0 002-2v-2" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  Download CV saya
                </a>
              </div>
              <div className="flex flex-col gap-3">
                {contactLinks.map((c) => (
                  <a key={c.label} href={c.href} target={c.href.startsWith("mailto") ? undefined : "_blank"} rel="noopener noreferrer" className="contact-card rounded-2xl p-3 md:p-4" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)" }}
                    onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = c.accentBorder; (e.currentTarget as HTMLElement).style.background = c.accentBg; }}
                    ...
                    <div className="contact-icon-wrap w-9 h-9 md:w-10 md:h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: c.accentBg, border: `1px solid ${c.accentBorder}` }}>{c.icon}</div>
                    ...
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" style={{ color: "rgba(255,255,255,0.2)", flexShrink: 0 }}><path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </a>
                ))}
              </div>
            </div>
      ...
      {/* ── FOOTER ── */}
      <footer className="section-px pb-10 max-w-7xl mx-auto relative z-10">
